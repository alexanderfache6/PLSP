...
# result = pyreadr.read_r('/projectnb/modislc/users/fache/data/planet/phenology/Walnut_Gulch_Kendall_Grasslands/chunk_phenology_050.rda')
result = pyreadr.read_r('/projectnb/modislc/users/fache/data/planet/phenology/Walnut_Gulch_Kendall_Grasslands/chunk_phenology_001.rda')
